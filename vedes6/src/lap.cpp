...
Lap::Lap(POINT3DH c0, POINT3DH c1, POINT3DH c2, POINT3DH c3, GLdouble R, GLdouble G, GLdouble B){
	this->C0 = c0;
	this->C1 = c1;
	this->C2 = c2;
	this->C3 = c3;
...
POINT3D Lap::getNormalVector(){
	...
	this -> normVect = vectorial_product(AB, AC);
	return normVect;
}
...
GLdouble Lap::camDist(){
	...
	POINT3D CS = POINT3D((0-tmp.x), (0-tmp.y), (0-tmp.z)); 
	return norm(CS);
}